...
## Note from SavorSauce
This dataset was copied from another repository, which you can find here: https://github.com/Lornatang/ESPCN-PyTorch
- The main problem I had with this repository was that there wasn't actually any code that could upscale full video, which was the point of the paper.
- In this repository I implemented said code, hence the name "video super resolution"
- Most of the original code is the same, however, I added the video upscale feature
- You will find a detailed description of how to use it below, make sure to also follow the original documentation for anything I don't cover

## Using Video Super Resolution
- If you have not yet done so, make sure to *train your own network* so that you can get good results, refer to the previous documentation for steps on how to do this.
- Make sure that you have all of the requirements listed in the requirements.txt file
- Add a video to the folder that your project is in (preferably in mp4 format)
- Run the following command in your terminal: python videosr.py *path_to_video*
- It should take a second, and the finished video should show up in the test/videos folder
- If you don't see the video, check other folders (or refer to the config.py file for the path)
- If you enjoy this repository, make sure to give it a star :)
...
- For training, the T91 dataset was used, you can find it on kaggle here: https://www.kaggle.com/datasets/ll01dm/t91-image-dataset
- For testing, the Set5 dataset was used, this dataset was harder to find, and it doesn't really matter what images you use if you are just testing it out.
